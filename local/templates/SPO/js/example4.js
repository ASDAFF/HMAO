    ...
    $(function() {
        ...
        var AddressUpdate = function(){
            ...
            if(cityObj){
                if(address) address += ', ';
                var str='';
                for (var i = 0; i < cityObj.parents.length; i++) {
                    str+=cityObj.parents[i].name+' '+cityObj.parents[i].typeShort+', ';
                }
                if (cityObj.parents.length<2) str+=',';
                address =str+ cityObj.name+' '+cityObj.typeShort + ', ' ;
            ...
            $('[name="AbiturientProfile[abiturientProfileBirthplace]"]').val(address);
        }
...
(function($){
    $(function() {
        ...
        var city = $( '[name="cityr"]' );
        var street = $( '[name="streetr"]' );
        var building = $( '[name="buildingr"]' );
        var buildingAdd = $( '[name="building-addr"]' );
        var apartmentr = $( '[name="apartment"]' );
        ...
        // Проверка названия квартиры
        apartmentr.change(function(){
                AddressUpdate();
        });
        ...
        var AddressUpdate = function(){
            ...
            if(streetObj){
                if(address) address += ', ';
                address +=streetObj.name+' '+ streetObj.typeShort + ', ' ;
                //450076, Башкортостан Респ,, Забельский нп, Аксакова ул, дом № 6, корпус 1, квартира 35
                if(streetObj.zip) zip = streetObj.zip;
            }
            ...
            if(buildingAddVal){
                if(address) address += ', ';
                address += ' корпус ' + buildingAddVal;
            }

            var apartment = $.trim(apartmentr.val());
            if(apartment){
                if(address) address += ', ';
            ...
            address = (zip ? zip + ', ' : '') + address;
            $('#Registration').val(address);
            $('#Registration2').html(address);
        }
...
(function($){
    $(function() {
        ...
        var city = $( '[name="cityp"]' );
        var street = $( '[name="streetp"]' );
        var building = $( '[name="buildingp"]' );
        var buildingAdd = $( '[name="building-addp"]' );
        var apartmentr = $( '[name="apartmenp"]' );
