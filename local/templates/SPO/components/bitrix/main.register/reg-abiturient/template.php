                    ...
                    <form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="col-lg-6">
                                            <?switch ($FIELD)
                                                ...
                                                ?>
                                                        ...
                                                        <input size="30" type="password" id="pass" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="bx-auth-input form-control reginput">
                                            ...
                                            <?if($arResult["SECURE_AUTH"]):?>
                                                        ...
                                                        <div class="help-block" for="inputWarning1">
                                                            ...
                                                            Пароль должен состоять из букв верхнего и нижнего регистра, цифр и спецсимволов <b>@#$%</b> и иметь длину не менее 8 символов
                                                        </div>
                                                ...
                                                ?>
                                                        <input size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" id="confclass" class="form-control reginput"/>
                                                <?
                                                    break;
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-lg-offset-6">
                                <input type="submit" name="register_submit_button" class="btn btn-info" value="<?=GetMessage("AUTH_REGISTER")?>" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-12 ">
                                <hr/>
                                <p>
                                    После нажатия на кнопку "Зарегистрироваться", на указанный вами адрес будет отправлено письмо для активации личного кабинета. Перейдите по ссылке из письма, чтобы закончить создание личного кабинета.
                                </p>
                            </div>
                        </div>
                    </form>
