        ...
        <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            ...
            <div class="panel panel-info" >
                ...
                <div class="panel-heading">
                    <div class="panel-title">Регистрация организации</div>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <?  // Признак того, что регистрируется организация. Необходим при дальнейшей обработке регистрационных данных
                            // пользователя - создания соответствующих инфоблоков ?>
                        <input type="hidden" name="userRole" value="organization" />
                                    ...
                                    <div class="col-lg-6">
                                        <?switch ($FIELD)
                                        {
                                            case "PASSWORD":
                                                ...
                                                <input id="pass" size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="bx-auth-input form-control reginput" />
                                            ...
                                            <?endif?>
                                                ...
                                                <div class="help-block" for="inputWarning1">
                                                    <div class="err" style="display: none;">Ошибка ввода пароля</div>
                                                    Пароль должен состоять из букв верхнего и нижнего регистра, цифр и спецсимволов и иметь длину не менее 8 символов
                                                </div>
                                            ...
                                            case "CONFIRM_PASSWORD":
                                                ?>
                                                <input id="confclass" size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="form-control reginput" />
                                                <?
                                                break;
                                            ...
                                            default:
                                                if ($FIELD == "PERSONAL_BIRTHDAY"):?><small><?=$arResult["DATE_FORMAT"]?></small><br /><?endif;?>
                                                    <input size="30" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" class="form-control reginput" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="checkbox" name="REGISTER[maderator]" onclick="directorchange()">
                            </div>
                        </div>
                        <div class="form-group" id="regOrganization">
                            <label class="col-lg-6 control-label">
                                Организации:
                            </label>
                            <div class="col-lg-6">
                                <select style="width:246px" name="REGISTER[Organization]">
                                    <? foreach ($arResult["organizacia"] as $item){?>
                                        <? if(!empty($item['Name'])){?>
