...
<div class="row">
    <div class="col-md-12">
        ...
        <div role="tabpanel">
            ...
            <form id="abiturient-profile-form" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content" style=" padding-top: 20px;">
                    ...
                    <div class="tab-pane active" id="tab-main">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <? if(!empty($userData['PERSONAL_PHOTO'])) {
                                    ...
                                    echo '<span class="profile-empty-photo">Фото не загружено</span>';
                                }?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select id="nationalityCountrySelect"
                                        name="AbiturientProfile[abiturientProfileNationality]" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="abiturientProfileBirthday"
                                       name="AbiturientProfile[abiturientProfileBirthday]" class="form-control input-md"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input name="citys" class="form-control input-md" type="text" value="<?= $profileData['abiturientProfileBirthplace'] ?>">
                                <input name="AbiturientProfile[abiturientProfileBirthplace]" class="form-control input-md" type="text" readonly value="<?= $profileData['abiturientProfileBirthplace'] ?>">
                                <span class="error-list label label-danger"></span>
                            </div>
                        </div>
                        <!--<div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label"><i class="fa fa-asterisk"></i>Адрес проживания по прописке</label>
                            <div class="col-md-8">
                                <div id="klad">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input <? if($arResult['EroorInn']==1){?>style="border-color:#d9534f"<?}?> name="AbiturientProfile[abiturientProfileINN]" class="form-control input-md"
                                       type="text" value="<?= $profileData['abiturientProfileINN'] ?>">
                                <span class="error-list label label-danger"></span>
                            </div>
                        </div>
                                ...
                                <div class="checkbox">
                                    <label for="checkboxes">
                                        <input
                                            ...
                                            <?if(empty($profileData['abiturientProfileSNILS'])) echo 'checked'?>
                                        >
                                    </label>
                                </div>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab-education">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label"><i class="fa fa-asterisk"></i>Серия документа об образовании</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input name="AbiturientProfile[abiturientProfileCAS]" class="form-control input-md"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php foreach (BaseEducation::getValuesArray() as $key => $value): ?>
                                    <label class="radio-inline">
                                        <input name="AbiturientProfile[abiturientProfileEducation]"
                                               value="<?= $key ?>" <?php if ($key == $profileData['abiturientProfileEducation']) echo 'checked' ?>
                                               type="radio">
                                        <?= $value ?>
                                    </label>
                                <? endforeach; ?>
                                ...
                                <div class="checkbox">
                                    <label for="checkboxes">
                                        <input
                                            ...
                                            <?php if ($profileData['abiturientProfileFirstTimeEnrolment']) echo 'checked' ?>
                                            value="1"
                                            type="checkbox"
                                            checked="checked"
                                        >
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab-additional">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label"><i class="fa fa-asterisk"></i>Адрес проживания</label>
                            <div class="col-md-8">
                                <div id="klad">
                                    <input name="cityp" type="text" value="" placeholder="Город" class="form-control" autocomplete="off" style="float:left; width:37%">
                                    <input name="streetp" type="text" value="" placeholder="Улица" class="form-control" autocomplete="off" style="float:left; width:33%">
                        ...
                        <!--<div class="form-group" id="abiturientProfileSeniorityString">
                            <label class="col-md-4 control-label">Адрес проживания</label>
                            <div class="col-md-8">
                                <input name="AbiturientProfile[AddressResidence]"
                                       class="form-control input-md" type="text"
                                       value="<?/*= $profileData['AddressResidence'] */?>">
                                <span class="error-list label label-danger"></span>
                            </div>
                        </div>-->
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab-files">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="file" name="AbiturientProfile[identityDocumentScanFile]" accept="image/*,image/jpeg" value="">
                                <span class="help-block">
                                    Скан-копия паспорта (первый разворот и прописка)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="file" name="AbiturientProfile[INNScanFile]">
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="file" name="AbiturientProfile[SNILSScanFile]">
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="file" name="AbiturientProfile[educationDocumentScanFile]">
                                <span class="help-block">
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab-parents">
                                ...
                                <?php foreach (Parents::getValuesArray() as $key => $value): ?>
                                    <label class="radio-inline <?=Parents::getClassArray()[$key]?>">
                                        <input name="AbiturientProfile[abiturientParents]"
                                               class="<?=Parents::getClassArray()[$key]?>"
                        ...
                        <div id="firstparent">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">ФИО матери</label>
                                <div class="col-md-8">
                                    <input class="form-control input-md" type="text" size="40" name="AbiturientProfileParent[fio][0]" value="<?=$profileData['abiturientProfileParent'][$n]['fio'];?>">
                                    <span class="error-list label label-danger"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="abiturientProfileBirthdayParentMama"
                                           name="AbiturientProfileParent[birthdate][0]" class="form-control input-md"
                                           type="text" value="<?=$profileData['abiturientProfileParent'][$n]['birthdate']?>">
                                    <span class="error-list label label-danger"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" id="ParentSNILS1">
                                <label class="col-md-4 control-label"><i class="fa fa-asterisk"></i>Номер СНИЛС</label>
                                <div class="col-md-8">
                                    <input name="AbiturientProfileParent[snils][0]" class="form-control input-md snils"
                                    ...
                                    <div class="checkbox">
                                        <label for="checkboxes">
                                            <input
                                                ...
                                                name="AcceptSNILS"
                                                type="checkbox"
                                                <?if(empty($profileData['abiturientProfileParent'][$n]['snils']))  echo 'checked'?>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label"><i class="fa fa-asterisk"></i>Документ выдан</label>
                                <div class="col-md-8">
                                    <input name="AbiturientProfileParent[docissuedpers][0]"
                                           class="form-control input-md" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="abiturientProfileParentIdentityDocumentIssuedDateMama"
                                           ...
                                           class="form-control input-md" type="text"
                                           value="<?=date("d-m-Y",strtotime($profileData['abiturientProfileParent'][$n]['docdatepers']))?>">
                                    <span class="error-list label label-danger"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input name="AbiturientProfileParent[dobdocument][0]"
                                           class="form-control input-md guard" type="text"
                        ...
                        <div id="secondparent">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control input-md" type="text" size="40" name="AbiturientProfileParent[fio][1]" value="<?=$profileData['abiturientProfileParent'][$n]['fio'];?>">
                                    <span class="error-list label label-danger"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="abiturientProfileBirthdayParentPapa"
                                           name="AbiturientProfileParent[birthdate][1]" class="form-control input-md"
                                           type="text" value="<?=$profileData['abiturientProfileParent'][$n]['birthdate']?>" onclick="BX.calendar();">
                                    <span class="error-list label label-danger"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" id="ParentSNILS2">
                                <label class="col-md-4 control-label"><i class="fa fa-asterisk"></i>Номер СНИЛС</label>
                                <div class="col-md-8">
                                    <input name="AbiturientProfileParent[snils][1]" class="form-control input-md snils"
                                           type="text" value="<?=$profileData['abiturientProfileParent'][$n]['snils']?>"
                ...
                <div class="col-md-offset-4 col-md-8">
                    ...
                    <input type="hidden" name="backurl" value="<?=$_SERVER['SCRIPT_URI'].'?userId='.$profileData['userId']?>">
                    <button class="btn btn-info" type="submit" <?if(!empty($profileData['NameOrgVer'])) echo disabled?>><i class="fa fa-check"></i>Сохранить профиль</button>
                </div>
                <!--/fieldset-->
            </form>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "?>
        <?if(empty($profileData['abiturientProfileParent'][1]['snils'])) echo "        
        avaliable($('#AcceptParentSNILS1'), $('#ParentSNILS1'));
        "?>
        <?if(empty($profileData['abiturientProfileParent'][2]['snils'])) echo "
