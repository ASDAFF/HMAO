...
<div class="application-list-page">
    <h2 class="page-header">Список заявок на поступление</h2>
                    ...
                    <div class="form-group filter-status" role="group">
                        ...
                        <div class="col-lg-7">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <?}?>-->
                                <li><a data-value="1" href="#">На рассмотрении</a></li>
    ...
    <script>
        ...
        $(function(){
            ...
            $resetFilterBtn.on('click', function(){
                ...
                window.location='/organization-office/application/list?'+Ogranich;
            });
            //Фильтр статуса
            $filterOrderBy
                .find('span')
