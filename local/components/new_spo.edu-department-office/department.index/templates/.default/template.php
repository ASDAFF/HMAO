...
<div class="department-dashboard">
    ...
    <a href="<?=Url::toAdmissionPlanBySpecialtyView()?>" class="btn btn-sm btn-default">
        <i class="fa fa-edit"></i>Контрольные цифры приёма по специальностям
    </a>
    <br><br style="width: 0px;margin-top: 4px;display: block;">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p><strong> Коммерческих мест: </strong> <?=$admissionPlansStat['intramuralTuitionStudentsNumber'] + $admissionPlansStat['extramuralTuitionStudentsNumber']?></p>
                    <p class="text-danger">
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        data.addRows([
            ...
            ['Очно, коммерция', <?=$admissionPlansStat['intramuralTuitionStudentsNumber']?>],
            ['Заочно, коммерция', <?=$admissionPlansStat['extramuralTuitionStudentsNumber']?>]
        ]);
...
<?php
 if(count($applicationsStat['applicationsByDate'])!=0){
?>
 <script type="text/javascript">
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Месяц', 'Бюджет очно', 'Бюджет заочно', 'Коммерция очно', 'Коммерция заочно'],
